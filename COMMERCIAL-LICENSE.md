...
Subject to the terms of this Agreement and payment of the applicable license fee, Licensor grants Licensee a non-exclusive, non-transferable, non-sublicensable license to:

- **Download, compile, and run** the software internally for Licensee's own business operations.
- **Modify** the source code solely for Licensee's internal use, including bug fixes and adaptations to fit specific internal requirements. All such modifications must remain internal to Licensee.

## 2. Restrictions

Licensee shall **NOT**:

- **Redistribute, sell, rent, lease, or sublicense** the software or any portion thereof to any third party.
- **Embed or integrate** the software (in whole or in part) into any product, platform, or service that is sold, distributed, or made commercially available to third parties.
- **Create derivative works** intended for external distribution or commercial sale.
- **Remove or alter** any copyright, trademark, or license notices contained in the software.
...
Use of the software as part of a Software-as-a-Service (SaaS) offering or any externally-facing commercial service is **not covered** by this license. A separate commercial agreement must be negotiated with Licensor.
...
For licensing inquiries, SaaS agreements, or questions:

📧 **ecosystem@plasticity.cloud**
